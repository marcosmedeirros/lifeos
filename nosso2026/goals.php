...
<head>
  ...
  <style>
    ...
    .b-facil{background:#1a1a1a;color:#aaa;border:1px solid #333}
    .b-medio{background:#252525;color:#ccc;border:1px solid #444}
    .b-dificil{background:#303030;color:#fff;border:1px solid #555}
      ...
      <div id="goalModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.8); z-index:100;" onclick="closeModal()">
        <div class="glass rounded-2xl p-6 max-w-lg mx-auto mt-20" onclick="event.stopPropagation()">
          ...
          <form method="post" id="goalForm">
            ...
            <input type="hidden" name="owner" id="goalOwner" value="geral">
            <div class="mb-4">
              <label class="block text-sm font-bold mb-2">Dificuldade</label>
              <select name="difficulty" id="goalDifficulty" class="w-full bg-[#1a1a1a] border border-[#333] rounded-xl p-3 text-white">
            ...
            <div class="mb-4">
              ...
              <input name="title" id="goalTitle" class="w-full bg-[#1a1a1a] border border-[#333] rounded-xl p-3 text-white" placeholder="Ex.: Correr 10k" required>
            </div>
