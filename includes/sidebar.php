...
<button id="menu-toggle" class="md:hidden fixed top-4 left-4 z-50 bg-white hover:bg-gray-200 text-black p-3 rounded-xl shadow-lg transition-all duration-300 touch-manipulation" aria-label="Menu" style="display: block !important;">
    ...
    <div class="mb-10 flex items-center gap-3 px-2">
        <div class="w-10 h-10 rounded-xl bg-white flex items-center justify-center shadow-lg">
            ...
            <svg class="w-7 h-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="3" y="4" width="18" height="18" rx="2" stroke="#000000" stroke-width="2"/>
                <path d="M3 10h18" stroke="#000000" stroke-width="2"/>
                <path d="M7 2v4M17 2v4" stroke="#000000" stroke-width="2" stroke-linecap="round"/>
                <!-- Checkmarks -->
                <path d="M7 14l1.5 1.5L11 13" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M13 14l1.5 1.5L17 13" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M7 18l1.5 1.5L11 17" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
        <h1 class="text-2xl font-bold text-white">LifeOS</h1>
    ...
    <div class="flex-1 flex flex-col">
        <div class="flex flex-col gap-2">
            ...
            <a href="<?php echo BASE_PATH; ?>/modules/strava.php" class="nav-btn <?php echo ($page === 'strava') ? 'active' : ''; ?> text-left px-4 py-3 flex items-center gap-3">
                <i class="fab fa-strava w-5 text-center"></i> <span>Treinos</span>
            </a>
