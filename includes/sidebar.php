<nav class="md:w-72 glass-sidebar p-6 flex flex-col fixed md:fixed md:top-0 md:left-0 w-full z-10 bottom-0 md:bottom-auto md:h-screen md:overflow-y-auto shadow-2xl">
    ...
    <div class="flex-1 flex flex-col">
        <div class="flex md:flex-col gap-2 overflow-x-auto md:overflow-visible no-scrollbar pb-2 md:pb-0">
            <a href="/lifeos/" class="nav-btn <?php echo ($page === 'dashboard') ? 'active' : ''; ?> text-left px-4 py-3 flex items-center gap-3">
                <i class="fas fa-chart-pie w-5 text-center"></i> <span>Dashboard</span>
            </a>
            <a href="/lifeos/modules/routine.php" class="nav-btn <?php echo ($page === 'routine') ? 'active' : ''; ?> text-left px-4 py-3 flex items-center gap-3">
                <i class="fas fa-sun w-5 text-center"></i> <span>Rotina</span>
            </a>
            <a href="/lifeos/modules/strava.php" class="nav-btn <?php echo ($page === 'strava') ? 'active' : ''; ?> text-left px-4 py-3 flex items-center gap-3">
                <i class="fab fa-strava w-5 text-center text-orange-500"></i> <span>Strava</span>
            </a>
            <a href="/lifeos/modules/activities.php" class="nav-btn <?php echo ($page === 'activities') ? 'active' : ''; ?> text-left px-4 py-3 flex items-center gap-3">
                <i class="fas fa-check-circle w-5 text-center"></i> <span>Atividades</span>
            </a>
            <a href="/lifeos/modules/events.php" class="nav-btn <?php echo ($page === 'events') ? 'active' : ''; ?> text-left px-4 py-3 flex items-center gap-3">
                <i class="fas fa-calendar-alt w-5 text-center"></i> <span>Calendário</span>
            </a>
            <a href="/lifeos/modules/finance.php" class="nav-btn <?php echo ($page === 'finance') ? 'active' : ''; ?> text-left px-4 py-3 flex items-center gap-3">
                <i class="fas fa-wallet w-5 text-center"></i> <span>Finanças</span>
            </a>
            <a href="/lifeos/modules/habits.php" class="nav-btn <?php echo ($page === 'habits') ? 'active' : ''; ?> text-left px-4 py-3 flex items-center gap-3">
                <i class="fas fa-fire w-5 text-center"></i> <span>Hábitos</span>
            </a>
            <a href="/lifeos/modules/goals.php" class="nav-btn <?php echo ($page === 'goals') ? 'active' : ''; ?> text-left px-4 py-3 flex items-center gap-3">
                <i class="fas fa-bullseye w-5 text-center"></i> <span>Metas</span>
            </a>
            <a href="/lifeos/modules/notes.php" class="nav-btn <?php echo ($page === 'notes') ? 'active' : ''; ?> text-left px-4 py-3 flex items-center gap-3">
                <i class="fas fa-sticky-note w-5 text-center"></i> <span>Notas</span>
            </a>
            <a href="/lifeos/modules/workouts.php" class="nav-btn <?php echo ($page === 'workouts') ? 'active' : ''; ?> text-left px-4 py-3 flex items-center gap-3">
                <i class="fas fa-dumbbell w-5 text-center"></i> <span>Treinos</span>
            </a>
            <a href="/lifeos/modules/game.php" class="nav-btn <?php echo ($page === 'game') ? 'active' : ''; ?> text-left px-4 py-3 flex items-center gap-3">
